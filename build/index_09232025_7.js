 ...
 */
function getChordsFromProgression(progression, scale, octave) {
 ...
 */
function generateDrumTrack(totalBeats) {
 ...
 * @returns {any} A MidiWriter.Track object.
 */
function generateBassTrack(chords, octave) {
    const track = new MidiWriter.Track();
 ...
 * @returns {any} A MidiWriter.Track object.
 */
function generateArpeggioTrack(chords) {
    const track = new MidiWriter.Track();
 ...
 * @returns {any} A MidiWriter.Track object.
 */
function generatePadTrack(chords) {
    const track = new MidiWriter.Track();
...
// --- MCP Tool Definition ---
server.tool("play_retrowave_song", "Generates and plays a layered retro-ambient EDM synth song.", {
