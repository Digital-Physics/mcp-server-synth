...
function blendBuffers(a, b, mix = 0.5) {
...
function maybeMutateBuffer(buffer, sampleRate) {
    let out = buffer;
...
// --- Composition Logic ---
function getComposition(tone, repeats = 32) {
    const allSamples = {
...
// --- MCP Tool ---
server.tool("play_layered_music", "Play music with multiple layered tracks, effects, and variation.", {
