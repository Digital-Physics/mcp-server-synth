...
function generateRetroWave(notes, durationSec = 2, sampleRate = 44100) {
...
async function synthesizeRetroTrack(tone, filename) {
...
let lastTrack = "";
// --- MCP Tools ---
server.tool("synthesize_music", "Generate retro synth music based on tone", {
...
server.tool("play_music", "Play the last generated retro synth track", {}, async () => {
